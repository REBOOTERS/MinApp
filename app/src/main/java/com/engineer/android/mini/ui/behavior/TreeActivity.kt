...
import com.engineer.android.mini.databinding.ActivityTreeBinding

class TreeActivity : AppCompatActivity() {
    private val TAG = "ArtsActivity"
    private val path = "file:///android_asset/arts/tree/index.html";
    private lateinit var viewBinding: ActivityTreeBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        viewBinding = ActivityTreeBinding.inflate(layoutInflater)

...
import com.engineer.android.mini.databinding.ActivitySelectBinding
        ...
        if (!hasPermissions) {
            if (permissionRequestCount < MAX_NUMBER_REQUEST_PERMISSIONS) {
                ...
                ActivityCompat.requestPermissions(
                    this, sPermissions.toTypedArray(), REQUEST_CODE_PERMISSIONS
                )
            } else {
                Snackbar.make(
    ...
    companion object {
        ...
        private fun fromHtml(input: String): Spanned {
            return if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
                ...
                @Suppress("DEPRECATION") Html.fromHtml(input)
            }
        }
    }
}
